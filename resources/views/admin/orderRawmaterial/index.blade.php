  ...
  <div class="container mt-3">
    <div class="row">
        <div class="col-lg-12   text-center ">
            <h2 >ข้อมูลการสั่งซื้อวัตถุดิบ</h2>
        </div>
      
        <div class="pl-0">
        <a href="{{route('addOrderRawmaterial')}}" class="btn btn-primary mt-1 "><i class="bi bi-plus-square-fill pl-0"></i> เพิ่มการสั่งวัตถุดิบ</a>
        </div>
