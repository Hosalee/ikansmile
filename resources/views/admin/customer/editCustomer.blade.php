...
<main class="col bg-faded py-4 flex-grow-1">
    <div class="container mt-5">
        <div class="row">
            ...
            <form action="{{url('/customer/updateCustomer/'.$Customer->customers_id)}}"  method="POST" enctype="multipart/form-data" class=" p-2">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            <label>ที่อยู่</label>
                            <input type="text" name="Address" class="form-control mt-1" value="{{$Customer->Address}}">
                            @error('Address')
                                <div class="alert alert-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
